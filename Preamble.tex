...
\usepackage{todonotes}%, nag} %workflow stuff, doesn't affect final document

% Layout
\usepackage{fancyhdr}
\usepackage[margin=1in]{geometry}
\mathtoolsset{showonlyrefs} % hides equation numbers if they are never referenced
